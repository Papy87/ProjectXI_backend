...
router.put('/posts/like', token_authentification, PostCorntrollers.LikeAndDislike);
router.put('/posts/:id', token_authentification, upload.fields([{name: 'image_url', maxCount: 5}, {
    name: 'video_url',
    maxCount: 1
}]),PostCorntrollers.UpdatePostByID);
